...
Vtiger_List_Js("Vtiger_FindDuplicates_Js",{
    ...
    loadListViewRecords : function(params) {        
		...
		var url = 'index.php?module='+moduleName+'&view=FindDuplicates&viewname='+viewname+'&fields='+fields+'&ignoreEmpty='+ignoreEmpty+'&page='+params.page;
    ...
    */ 
	...
	getRecordsCount : function(){
        ...
        var postData = {
            ...
            "fields": fields, "ignoreEmpty":ignoreEmpty,"viewname":viewname
        }
